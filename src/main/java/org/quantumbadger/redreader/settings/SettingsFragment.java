...
public final class SettingsFragment extends PreferenceFragment {
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		final int[] listPrefsToUpdate = {
				...
				R.string.pref_menus_optionsmenu_items_sort_key,
				R.string.pref_menus_optionsmenu_items_refresh_key,
				R.string.pref_menus_optionsmenu_items_past_key,
				R.string.pref_menus_optionsmenu_items_submit_post_key,
				R.string.pref_menus_optionsmenu_items_pin_key,
				R.string.pref_menus_optionsmenu_items_block_key,
				R.string.pref_menus_optionsmenu_items_subscribe_key,
				R.string.pref_menus_optionsmenu_items_sidebar_key,
				R.string.pref_menus_optionsmenu_items_accounts_key,
				R.string.pref_menus_optionsmenu_items_theme_key,
				R.string.pref_menus_optionsmenu_items_settings_key,
				R.string.pref_menus_optionsmenu_items_close_all_key,
				R.string.pref_menus_optionsmenu_items_reply_key,
				R.string.pref_menus_optionsmenu_items_search_key
		};
